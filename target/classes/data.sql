...
INSERT INTO t_vet (id,first_name,last_name) VALUES (1, 'Ali', 'Güç');
INSERT INTO t_vet (id,first_name,last_name) VALUES (2, 'Bekir', 'Sağ');
INSERT INTO t_vet (id,first_name,last_name) VALUES (, 'Kadir', 'Mutlu');
...
INSERT INTO USERS VALUES('user1','{bcrypt}$2a$10$Y0cQ3XRpYdiLyTN1/35A9utjli6jy595GHdQOVheUmgzLJFVpN2Dm',TRUE);
INSERT INTO USERS VALUES('user2','{bcrypt}$2a$10$O4dOZvXo/qNxYLHXk4SwwuD9xUq218iwAzDVWVAC0QarFtyhDfakC',TRUE);
INSERT INTO USERS VALUES('user3','{bcrypt}$2a$10$HCW7W.YHEC1MJ5/VrE6vju/oTsoM6uN5cClyRfUwlGZndWLNLDlce',TRUE);
